...
label:
  ...
  // cout<<j<<" ";
   // cout<<kount;
    ...
    else if(kount==11&&grid[2+x][2+y]=='*')
        cout<<"I";
    else if(kount==11&&grid[2+x][3+y]=='*')
        cout<<"J";
    else if(kount==11&&grid[0+x][0+y]=='*'&&grid[6+x][4+y])
        cout<<"L";
    else if(kount==11&&grid[2+x][2+y]=='*'&&grid[0+x][0+y])
        cout<<"T";
    ...
    else if(kount==18&&grid[0+x][0+y]=='*'&&grid[0+x][4+y]=='*'&&grid[6+x][4+y]=='*'&&grid[6+x][0+y]=='*'&&grid[3+x][2+y]=='*')
        cout<<"E";
